...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(8, 0, 0.018);
    ...
    public List<Double> getWheelPositions() {
        ...
        for (DcMotorEx motor : motors) {
            ...
            wheelPositions.add(encoderTicksToInches(position) * X_MULTIPLIER);
        }
    ...
    public List<Double> getWheelVelocities() {
        ...
        for (DcMotorEx motor : motors) {
            ...
            lastEncVels.add(vel);
            wheelVelocities.add(encoderTicksToInches(vel) * Y_MULTIPLIER);
        }
